// useReducer <- hook do React que recebe um reducer e um estado inicialMore actions
...
// payload <- os dados extras enviados junto com a action, se necessário para atualizar o estadoMore actions
